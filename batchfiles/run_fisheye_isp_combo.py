...
def _convert1to3(input_file, args, output_filename = None):
    '''
...
def _run_with_effects(input_file, args, effect_functions):
    ...
    rectified_file = _convert1to3(fisheye_file, args, _extract_filename(input_file.name))
    ...
    for fisheye_file in fisheye_files:
        ...
        if add_effect := rng.choice([True, False], p=[0.95, 0.05]):
            _run_with_effects(fisheye_file, args, [
                    _add_vignette, _add_demosaicing, _add_blur,
