...
def _run_with_effect(input_file, args, effect_func):
    fisheye_file = effect_func(input_file, args)
...
def _no_effect(input_file, args):
    return input_file


def _process_fisheyes(fisheye_files, args):
    for fisheye_file in fisheye_files:
        _run_with_effect(fisheye_file, args, _no_effect)
        _run_with_effect(fisheye_file, args, _add_vignette)
        _run_with_effect(fisheye_file, args, _add_demosaicing)
        _run_with_effect(fisheye_file, args, _add_fixed_isp)
        _run_with_effect(fisheye_file, args, _add_random_isp)
        _run_with_effect(fisheye_file, args, _add_dark_isp)
